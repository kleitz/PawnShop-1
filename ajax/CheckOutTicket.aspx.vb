...
Partial Class ajax_CheckOutTicket
    Inherits System.Web.UI.Page

    Private Sub ajax_CheckOutTicket_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            For value As Integer = 0 To data.Ticket.Count - 1
                updateCheckOut(Username, eventId, data.Ticket(value))
            Next

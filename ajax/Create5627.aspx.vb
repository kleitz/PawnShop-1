...
Partial Class ajax_Create5627
    Inherits System.Web.UI.Page

    Private Sub ajax_Create5627_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        CrytalBuild.CreateReport("5627.rpt", para, spara)
    End Sub
End Class

...
Partial Class ajax_DetailTicketHeader
    Inherits System.Web.UI.Page

    Private Sub ajax_DetailTicketHeader_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        dt = DataConnection.DataAccessClassAsset.getTicketInfoHeader(TicketID)

...
Partial Class ajax_DetailEstimateLog
    Inherits System.Web.UI.Page

    Private Sub ajax_DetailEstimateLog_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        dt = DataConnection.DataAccessClassAsset.getEstimateLog(TicketID)

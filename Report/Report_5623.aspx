<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_5623.aspx.vb" Inherits="Report_5623" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnGenReport5623').click(function () {
                var branch = $('#ddlBranch').val();
                var period = $('#ddlperiod').val();
                var month = $('#ddlMonth').val();
                var year = $('#ddlyear').val();

                window.open("ajax/Create5623.aspx?branch=" + branch + "&period=" + period + "&month=" + month + "&year=" + year);
...
<body>
    ...
    <h3>บัญชีประเมินราคาทรัพย์หลุดเป็นกรรมสิทธิ์แยกตามประเภท</h3>
    <div class="uk-form">
        <table>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <button id="btnGenReport5623" class="uk-button uk-button-primary" style="color: #ffffff">ออกรายงาน</button>
                </td>
            </tr>
        </table>
    </div>
